const events = require("events"),
  ...
  multi = require("./multi"),
  keyfunctions = require("./keys.js"),
  hashing = require("./hash.js"),
  listfunctions = require("./list.js"),
  setfunctions = require("./set.js"),
  sortedset = require("./sortedset.js"),
  serverfunctions = require("./server.js"),
  MockInstance = require('./redis-mock');
...
RedisClient.prototype.scan = RedisClient.prototype.SCAN = parsed(parsers.scan, (args, cb) => {
  ...
  keyfunctions.scan.call(this, MockInstance, args.default.cursor, args.named.match, args.named.count, cb);
});
...
RedisClient.prototype.set = RedisClient.prototype.SET = parsed(parsers.set, (args, cb) => {
  ...
  const postProcess = () => {
    if (expirationTime) {
      keyfunctions.expire.call(this, MockInstance, args.default.key, expirationTime, (err, result) => {
...
RedisClient.prototype.setex = RedisClient.prototype.SETEX = function (key, seconds, value, callback) {
  ...
  MockInstance.set(key, value, () => {
    keyfunctions.expire.call(self, MockInstance, key, seconds, function(err, result) {
...
RedisClient.prototype.mget = RedisClient.prototype.MGET = function (...arguments) {
  MockInstance.mget(...arguments);
};

RedisClient.prototype.mset = RedisClient.prototype.MSET = function (...arguments) {
  MockInstance.mset(false, ...arguments);
};

RedisClient.prototype.msetnx = RedisClient.prototype.MSETNX = function (...arguments) {
  MockInstance.mset(true, ...arguments);
};
...
RedisClient.prototype.sscan = RedisClient.prototype.SSCAN = parsed(parsers.sscan, (args, cb) => {
  setfunctions.sscan.call(this, MockInstance, args.default.key, args.default.cursor, args.named.match, args.named.count, cb);
});

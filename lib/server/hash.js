...
exports.hexists = function (hash, key, callback) {
  ...
  this._callCallback(callback, err, b);
}
...
exports.hdel = function (hash) {
  ...
  if (callback) {
    this._callCallback(callback, err, nb);
  }
}
...
exports.hset = function (hash, key, value, callback) {
  ...
  if (this.storage[hash]) {
    if (this.storage[hash].type !== "hash") {
      return this._callCallback(callback,
  ...
  this._callCallback(callback, null, update ? 0 : 1);
};
...
exports.hincrby = function (hash, key, increment, callback) {
  ...
  this._callCallback(callback, null, parseInt(this.storage[hash].value[key], 10)); //Because HINCRBY returns integers
};
...
exports.hincrbyfloat = function (hash, key, increment, callback) {
  ...
  this._callCallback(callback, null, this.storage[hash].value[key]);
};
...
exports.hgetall = function (hash, callback) {
  ...
  this._callCallback(callback, null, nb === 0 ? null : obj);
}
...
exports.hkeys = function (hash, callback) {
  ...
  this._callCallback(callback, null, list);
}
...
exports.hmget = function (mockInstance) {
  ...
  // Do we have a callback?
  if ('function' === typeof arguments[arguments.length - 1]) {
    this._callCallback(arguments[arguments.length - 1], err, keyValues);
  }
}
...
exports.hlen = function (hash, callback) {
  ...
  this._callCallback(callback, null, cnt);
}

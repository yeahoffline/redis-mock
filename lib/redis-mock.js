...
RedisClient.prototype.sscan = RedisClient.prototype.SSCAN = function () {
  var args = parseArguments(arguments);
  var callback = args.pop();
  var key = args[0];
  var index = typeof args[1] === 'number' ? args[1] : 0;
  var match = '*';
  var count = 10;
  ...
  setfunctions.sscan.call(this, MockInstance, key, index, match, count, callback);
};

const events = require("events"),
  ...
  RedisMock = require('../server/redis-mock');
...
class RedisClient extends events.EventEmitter {
  ...
  constructor(options, stream, redisMock = new RedisMock()) {
    super();
 ...
 */
types.getMethods(RedisClient).public().skip('duplicate', 'quit', 'end').forEach(methodName => {
